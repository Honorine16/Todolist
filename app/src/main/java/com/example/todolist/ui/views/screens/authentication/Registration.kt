        ...
        Scaffold (
            ...
            Column (
                ...
                Spacer(modifier = Modifier
                    .height(dimensionResource(id = R.dimen.size_4)))
                Column(
                    ...
                    onClick = {
                        ...
                        if (!isError) {
                            ...
                            scope.launch {
                                ...
                                if (!isTermsAccepted) {
                                    isFullNameError = true
                                    isFullNameErrorText = context.getString(R.string.accept_terms_and_conditions)
                                    isLoading = false
                                } else {
                                    if (authState.usersList.isNotEmpty()){
                                        ...
                                        authViewModel.sendOTPCode(
                                            com.example.todolist.app.todolist.data.room.models.OTPCode(
                                                email = email,
